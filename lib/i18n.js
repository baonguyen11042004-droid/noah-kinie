...
const dict = {
  vi: {
    ...
    heroCta: 'Gửi ảnh làm magnet', ribbon: 'Thủ công 100%', mascotAlt: 'Linh vật Kinie cầm những tấm ảnh',
  ...
  en: {
    ...
    heroCta: 'Send photos to print', ribbon: '100% handmade', mascotAlt: 'Kinie mascot holding photos',
